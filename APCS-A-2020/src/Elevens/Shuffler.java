...
public class Shuffler {
	...
	public static void main(String[] args) {
		...
		ArrayList<Card> values1 = new ArrayList<Card>();
		...
		ArrayList<Card> values2 = new ArrayList<Card>();
	 ...
	 */
	public static void perfectShuffle(String[] values) {
        String[] shuffled = new String[values.length];
        int k = 0;
